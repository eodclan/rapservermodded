        ...
        mp.events.add({
            ...
            "sMenu-ChangePass" : async (player, str) => {
                ...
                const mail = {
                    ...
                    to: `${player.email}`,
                    subject: `Das Passwort wurde geändert`,
            ...
            "sVehicle-SellToPlayer" : async (player, id) => {
                player.notify(`Das ist noch nicht möglich!`);
            },

            "sVehicle-SellToGovernment" : async (player, id) => {
                player.notify(`Das ist noch nicht möglich!`);
            },
