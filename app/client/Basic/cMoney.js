...
mp.events.add(
{
	...
	"cMoney-ShowATM" : (lang, execute) => {
		misc.prepareToCef(1);
		misc.openCef("package://RageV/Browsers/ATM/atm.html", lang);
	...
	"cMoney-SendNotification" : (message) => {
		...
		mp.game.ui.setNotificationMessage("CHAR_BANK_FLEECA", "CHAR_BANK_FLEECA", false, 2, 'FLEECA BANK', `Neue Nachricht`);
