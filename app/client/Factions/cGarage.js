...
mp.events.add({
	...
	"cGarage-ShowVisitorsGarageMenu" : (lang, execute, cam) => {
		misc.prepareToCef(1);
		misc.openCef("package://RageV/Browsers/Factions/VisitorsGarage/Garage/garage.html", lang);
	...
	"cGarage-ShowVisitorsLiftMenu" : (lang, execute) => {
		misc.prepareToCef(1);
		misc.openCef("package://RageV/Browsers/Factions/VisitorsGarage/Lift/lift.html", lang);
		misc.injectCef(execute);
	},
});
